...
const FeaturedProducts = () => {
  ...
  const microphones = products.slice(0, 2);
  const accessories = products.slice(2);
              ...
              >
                ...
                <div className="p-6">
                  <span 
                    ...
                    onBlur={(e) => {
                      const newProducts = [...products];
                      newProducts[index + 2].category = e.currentTarget.textContent || product.category;
                      setProducts(newProducts);
                    }}
                  >
                    {product.category}
                  ...
                  <h3 
                    ...
                    onBlur={(e) => {
                      const newProducts = [...products];
                      newProducts[index + 2].name = e.currentTarget.textContent || product.name;
                      setProducts(newProducts);
                    }}
                  >
                    {product.name}
                  ...
                  <p 
                    ...
                    onBlur={(e) => {
                      const newProducts = [...products];
                      newProducts[index + 2].price = e.currentTarget.textContent || product.price;
                      setProducts(newProducts);
                    }}
                  >
                    {product.price}
