...
const Support = () => {
  ...
  const placeholdersTH = ["ฉันสามารถติดตามคำสั่งซื้อของฉันได้อย่างไร?", "คุณรับวิธีการชำระเงินอะไรบ้าง?", "ฉันจะคืนสินค้าได้อย่างไร?", "ข้อมูลเกี่ยวกับนโยบายการรับประกันของคุณ", "ศูนย์บริการที่ใกล้ฉันที่สุดอยู่ที่ไหน?"];
  const placeholdersEN = ["How can I track my order?", "What payment methods do you accept?", "How do I return a product?", "Tell me about your warranty policy", "Where is my nearest service center?"];
  ...
  return <div className={`min-h-screen ${theme === 'dark' ? 'bg-black text-white' : 'bg-white text-black'}`}>
      <Helmet>
        ...
        <meta name="description" content={language === "en" ? "Get help with your SIAMTECH products, track orders, and access customer support." : "รับความช่วยเหลือเกี่ยวกับสินค้า SIAMTECH ติดตามคำสั่งซื้อ และเข้าถึงฝ่ายบริการลูกค้า"} />
        <html lang={language} />
      </Helmet>
      ...
      <div className="pt-24 pb-16 px-4 max-w-6xl mx-auto">
        ...
        <Card className={`${theme === 'dark' ? 'bg-black border-white/10' : 'bg-white border-gray-200'} mb-12`}>
          ...
          <CardContent>
            <PlaceholdersAndVanishInput placeholders={placeholders} onChange={handleChange} onSubmit={handleSubmit} className="text-left" />
          </CardContent>
        </Card>
